...
const styles = StyleSheet.create({
  textBold: {
    ...
    fontWeight: "900", // You can also set font weight directly here
    fontSize: 16,
      ...
      <Document>
        <Page size="A4" style={styles.page} wrap={false}>
            ...
            {props?.state?.businessUpdate[0]?.business_update_questions
              ...
              <>
                ...
                <Text style={styles.text} wrap={false}>
                  Current sales positions, hot prospects, recently contracted
                  work:
                </Text>
                ...
                <Text style={styles.text}>
                  How can the Craftsmen aid or support you with these
                  challenges?
                </Text>
                <Text style={styles.textarea} wrap={true}>
          ...
          <View style={styles.section}>
            ...
            {props?.state?.lastNextMeetings[0]?.goal_next_meeting?.map(
              (res, index) => (
          ...
          <View style={styles.section}>
            ...
            {props?.state?.futureMeetings[0]?.goal_next_meeting
              .slice(0, 3)
              ?.map((res, index) => (
                <View style={styles.goal} key={index}>
                  <View style={styles.div_per}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.goal}>
              {props?.state?.technologyData[0]
                ?.craftsmen_toolbox_update_questions ? (
                props?.state?.technologyData[0]?.craftsmen_toolbox_update_questions.map(
                  (res, index) => (
                    <>
                ...
                <>
                  <Text style={styles.text}>
                    Describe any new technology you started using and share the
                  ...
                  <Text style={styles.text}>
                    Describe something that you do with each project that sets
          ...
          <View style={styles.section}>
            ...
            <View style={styles.goal}>
              {props?.state?.craftsMenUpdates[0]
                ?.craftsmen_checkup_update_questions ? (
                props?.state?.craftsMenUpdates[0]?.craftsmen_checkup_update_questions.map(
                  (res, index) => (
                    <>
          ...
          {props?.state?.businessEvolutionIndustryTrendsUpdates?.length ? (
            <View style={styles.section}>
              ...
              <View style={styles.goal}>
                {props?.state?.businessEvolutionIndustryTrendsUpdates[0]
                  .business_evolution_update_industry_trends
                  ? props?.state?.businessEvolutionIndustryTrendsUpdates[0].business_evolution_update_industry_trends?.map(
                      (res, index) => (
                        <>
                          <Text style={styles.text} key={index}>
                            {res?.question}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.goal}>
              {props?.state?.meetingReviews?.length == 0 ||
              props?.state?.meetingReviews?.length >= 0 ? (
                props?.state?.meetingReviews[0]?.fallmeeting_review_update_questions?.map(
                  (res, index) => (
                    <>
                      <Text style={styles.text} key={index}>
                        {res?.question}
          ...
          {props?.state?.roundTableTopics[0]?.round_table ? (
            <View style={styles.section}>
              ...
              <View style={styles.goal}>
                ...
                <Text style={styles.text}>Second roundtable topic</Text>
                <Text style={styles.textarea} wrap={true}>
          ...
          {props?.state?.personalWellBeingUpdates ? (
            ...
            <View style={styles.section}>
              <Text style={styles.main_heading} wrap={false}>
                {" "}
