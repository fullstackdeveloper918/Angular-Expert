...
const MeetingAdd = () => {
  ...
  const onChangeDate1 = (date: any) => {
    const dateWithTimezone: any = date
      ? moment.tz(date, selectedTimezone)
      : null;
  ...
  const onSubmit = async (values: any) => {
    const hotel = selectedHotel
      ? `${selectedHotel?.name},${selectedHotel?.formatted_address}`
      : "";
    ...
    try {
      console.log(items, "items here to see submit data");
  ...
  const [next7DaysWeather, setNext7DaysWeather] = useState<
    { day: string; icon: string; temp: string }[]
  >([]);
  ...
  useEffect(() => {
    const fetchAndFilterWeather = async (
      lat: number,
      lon: number,
      startDate: Date,
      endDate: Date
      ...
      try {
        ...
        const weatherMap: {
          [key: string]: { icon: string; tempSum: number; count: number };
        } = {};
        ...
        const formattedWeather = Object.entries(weatherMap).map(
          ([day, { icon, tempSum, count }]) => {
                    ...
                    <div className="row mt-4 selectPaddingBox">
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Please Enter Meeting Type",
                          },
                        ]}
                        label="Meeting Type"
                      >
                      ...
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Please Enter Meeting Start Date",
                          },
                        ]}
                      ...
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Please Enter Meeting Start Time",
                          },
                        ]}
                      ...
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Please Enter Meeting End Date",
                          },
                        ]}
                      ...
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Please Enter Meeting End Time",
                          },
                        ]}
                      ...
                      >
                        ...
                        >
                          {Object.entries(companyNameMap).map(
                            ([key, value]) => (
                      ...
                      >
                        <p className="custom-input" style={{ width: "100%" }}>
                          ...
                          {next7DaysWeather.map(
                            ({ day, icon, temp }, index: number) => (
                              <div
                                className="gap-2"
                                key={index}
                                style={{
                      ...
                      {meetingType == "spring" && (
                        <Form.Item
                          ...
                          label="Note"
                        >
                          <TextArea size={"large"} placeholder="Note.." />
                        </Form.Item>
                      )}
                    </div>
                    {/* Button  */}
